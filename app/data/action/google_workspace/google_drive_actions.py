...
def list_drive_files(input_data: dict) -> dict:
    ...
    cred = creds[0]
    from agent_core.external_libraries.google_workspace.helpers.google_drive_helpers import list_drive_files as _list
...
def create_drive_folder(input_data: dict) -> dict:
    ...
    if not creds:
        return {"status": "error", "message": "No Google credential. Use /google login first."}
    cred = creds[0]
    from agent_core.external_libraries.google_workspace.helpers.google_drive_helpers import create_drive_folder as _create
...
def move_drive_file(input_data: dict) -> dict:
    ...
    if not creds:
        return {"status": "error", "message": "No Google credential. Use /google login first."}
    cred = creds[0]
    from agent_core.external_libraries.google_workspace.helpers.google_drive_helpers import move_drive_file as _move
