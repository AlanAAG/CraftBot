...
_STORE_MAP = {
    "google_workspace": ("agent_core.external_libraries.google_workspace.credentials", "GoogleWorkspaceCredential", "google_workspace_credentials.json", "email"),
    "slack": ("agent_core.external_libraries.slack.credentials", "SlackCredential", "slack_credentials.json", "workspace_id"),
    "notion": ("agent_core.external_libraries.notion.credentials", "NotionCredential", "notion_credentials.json", "workspace_id"),
    "linkedin": ("agent_core.external_libraries.linkedin.credentials", "LinkedInCredential", "linkedin_credentials.json", "linkedin_id"),
    "zoom": ("agent_core.external_libraries.zoom.credentials", "ZoomCredential", "zoom_credentials.json", "zoom_user_id"),
    "telegram_bot": ("agent_core.external_libraries.telegram.credentials", "TelegramCredential", "telegram_credentials.json", "bot_id"),
    "telegram_mtproto": ("agent_core.external_libraries.telegram.credentials", "TelegramCredential", "telegram_credentials.json", "phone_number"),
    "whatsapp": ("agent_core.external_libraries.whatsapp.credentials", "WhatsAppCredential", "whatsapp_credentials.json", "phone_number_id"),
    "whatsapp_web": ("agent_core.external_libraries.whatsapp.credentials", "WhatsAppCredential", "whatsapp_credentials.json", "phone_number_id"),
    "discord_bot": ("agent_core.external_libraries.discord.credentials", "DiscordBotCredential", "discord_bot_credentials.json", "bot_id"),
    "discord_user": ("agent_core.external_libraries.discord.credentials", "DiscordUserCredential", "discord_user_credentials.json", "discord_user_id"),
    "recall": ("agent_core.external_libraries.recall.credentials", "RecallCredential", "recall_credentials.json", "api_key"),
}
