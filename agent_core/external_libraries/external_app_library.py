...
if TYPE_CHECKING:
    from agent_core.core.config import CredentialClientProtocol
...
class ExternalAppLibrary(ABC):
    ...
    @classmethod
    def set_credential_client(cls, client: "CredentialClientProtocol") -> None:
        """
    ...
    @classmethod
    def get_credential_client(cls) -> Optional["CredentialClientProtocol"]:
